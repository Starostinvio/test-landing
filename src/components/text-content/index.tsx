  ...
  return (
    <div className="TextContent">
      <div>
        ...
        которых используется Lorem Ipsum. Почему он используется? Давно
        ...
        XVI века, приведён ниже. Также даны разделы 1.10.32 и 1.10.33 "de
        Finibus Bonorum et Malorum" Цицерона и их английский перевод, сделанный
        H. Rackham, 1914 год.
      </div>
      <div>
        Что такое Lorem Ipsum? Lorem Ipsum - это текст-"рыба", часто
